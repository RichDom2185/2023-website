var e=[{company:"National University of Singapore",link:"https://nus.edu.sg",position:"Bachelor's in Computer Science + Business Administration",from:"Aug 2021",to:"May 2025",description:`* ASEAN Undergraduate Merit Scholarship Recipient
...
`},{company:"Eunoia Junior College",link:"https://eunoiajc.moe.edu.sg",position:"Singapore-Cambridge GCE A Levels",from:"Jan 2019",to:"Nov 2020",description:`**Final Grade:** 6 Distinctions (AAAA/AA) &nbsp;&nbsp; **Rank Points:** 90/90
...
* H1 General Paper
* H1 Project Work
`}],n=[{company:"Flexii Pte. Ltd.",link:"https://flexii.net",position:"Full-Stack Software Engineer",from:"May 2024",to:"Aug 2024",description:`* Designed and developed backend architecture using **Java** and **Spring Boot** for long-term scalability and maintainability of the codebase serving **4,000** users
...
`,tech:["Java","Spring","Google Cloud Platform","Firebase","PostgreSQL","TypeScript","React","Redux","Flutter","Dart","JavaScript","GitHub","Docker","NGINX"]},{company:"Source Academy",link:"https://github.com/source-academy",position:"Chief Technology Officer",from:"May 2023",to:"Present",description:`I am the current Chief Technology Officer and Lead Developer of [Source Academy](https://sourceacademy.org/contributors).
...
`,tech:["React","TypeScript","Docker","Amazon Web Services","Elixir","AWS Lightsail","JavaScript","GitHub","Golang","PostgreSQL"]},{company:"National University of Singapore",link:"https://nus.edu.sg",position:"Undergraduate Teaching Assistant",from:"Jan 2023",to:"Present",description:`Courses taught:
...
`,tech:["Java","GitHub"]},{company:"Source Academy",link:"https://github.com/source-academy",position:"Robotics Head",from:"Sep 2022",to:"Apr 2024",description:`Created SEKER, a browser-based, backend-less runner for Python/Source programs on the LEGO SPIKE Prime, a MicroPython-based board, complete with Source language bindings for the SPIKE's internal Python API.
...
`,tech:["Chakra UI","Vite","TypeScript","Python","React","Golang"]},{company:"Source Academy",link:"https://github.com/source-academy",position:"Student Software Developer",from:"Aug 2022",to:"Dec 2022",description:`Developed a live dashboard to display real-time information on various sensors that are connected to remote Lego Mindstorms EV3 devices in Source Academy, a gamified online learning platform for Computer Science freshmen. This greatly enhances the collaborative learning experience for teams, especially for those who are not able to be present in person, benefitting over 800 freshmen yearly.
`,tech:["GitHub","C","TypeScript","React"]},{company:"Computing for Voluntary Welfare Organisations",link:"https://www.comp.nus.edu.sg/~vwo/projects/2022-aac.html",position:"Full Stack Developer Intern",from:"May 2022",to:"Aug 2022",description:`Collaborated with 15 other developers to maintain and further develop a Single Page Application for staff of Active Ageing Centres (AACs) serving over 12,000 elderly clients across Singapore, empowering their vision of scaling up to over half a million seniors in the next few years.
...
`,tech:["PostgreSQL","TypeScript","Ionic","GitLab","React","Golang"]},{company:"Source Academy",link:"https://github.com/source-academy",position:"Student Software Developer",from:"Jan 2022",to:"May 2022",description:`Created a Wi-Fi and QR code-based pairing workflow for linking Source Academy with LEGO Mindstorms EV3 devices, simplifying the out-of-the-box experience for Computer Science freshmen in the gamified online learning platform, enhancing the learning experience of over 800 students taking the introductory programming module every year.
`,tech:["Shell Scripting","C","Linux","Golang"]}];const t=e,i=n;export{t as educationExperiences,i as workExperiences};
